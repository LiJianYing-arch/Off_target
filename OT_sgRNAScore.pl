...
#Sub program
off_cal(TGAACACCGTTGCGGCTATGTGG,TGCACACTGTTGTAGCTTTGAGA,NGG);
off_cal(TGAACACCGTTGCGGCTATGTGG,TTTACACCGTTTCCTCTATGTGA,NGG);
off_cal(TGAACACCGTTGCGGCTATGTGG,TGAACTTTGTTGCTGCTGTGTGA,NGG);
off_cal(TGAACACCGTTGCGGCTATGTGG,TGAACCCCTTTGAGCCTATCAAG,NGG);
